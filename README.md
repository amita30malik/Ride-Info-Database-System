This project is a ride-info database system built using PostgreSQL to efficiently manage users, drivers, and rides. It includes structured tables with constraints for data integrity, 
